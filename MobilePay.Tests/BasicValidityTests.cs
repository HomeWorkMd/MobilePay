    ...
    public class BasicValidityTests
    {
        ...
        public void DiscountRule_OnlyAcceptsValidDiscountValues()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() =>
                new BigMerchantDiscountRule(null, new MerchantDiscount("a", -10)));
            Assert.Throws<ArgumentOutOfRangeException>(() =>
                new BigMerchantDiscountRule(null, new MerchantDiscount("a", 111)));
        }

        [Fact]
        public void FailureToParseTransactionData_shouldReturnFalse()
        {
            var rez = TransactionData.TryParse("This is wrong", out var _);
            Assert.False(rez);
        }
        ...
        {
            var rez = TransactionData.TryParse("   1999-01-01 xxx 1", out var data);
            Assert.True(rez);
        ...
        {
            Assert.True(TransactionData.TryParse("1999-01-01   xxx    1", out var data));
